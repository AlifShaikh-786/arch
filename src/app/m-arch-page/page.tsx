...
import WhyChooseAccordion from "@/src/sections/M-Arch/WhyChoose";
import FAQSection from "@/src/sections/M-Arch/FAQSection";
...
export default function Page() {
  ...
  const data = [
    {
      title: "Master of Architecture in Pune",
      description:
                ...
                <div key={index} className="relative pl-8 sm:pl-12 group">
                  ...
                  <div className="bg-[var(--secondary-bg)] border border-[var(--card-border)] p-6 rounded-[var(--r-btn)] shadow-sm transition-all duration-300 group-hover:shadow-md group-hover:border-[var(--primary)]/20">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
                      ...
                      <span className="inline-block w-max small1 text-[var(--primary)] bg-[var(--primary)]/10 px-2 py-0.5 ">
                        {step.timeframe}
                      </span>
                    </div>
