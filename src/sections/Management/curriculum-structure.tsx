...
export default function CurriculumStructure2() {
    ...
    <section className="py-20 px-5  bg-[var(--primary-bg)] border-b border-[var(--border-color)]">
      <div className="max-w-7xl mx-auto px-6">
        <div className=" justify-center flex flex-col">
          ...
          <div className="lg:col-span-4   lg:top-24 space-y-4 mb-10">
            <h2 className="text-[var(--text-1)] text-center">
              Academic{" "}
              <span className="text-[var(--primary)] ">Curriculum</span>
            </h2>
            <p className="text-[var(--text-2)] text-center max-w-3xl mx-auto">
